...
final class ArchitectureTest:
  @Test def productionRespectsBoundaries(): Unit =
    ...
    assertTrue("Graph snapshot policy must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.api.BendGraphSnapshot$"))
    assertTrue("Source mapping must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.model.BendSourceMapping"))
    assertTrue("Rewrite range must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.model.BendRewrittenRange"))
    assertTrue("Blanked import range must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.model.BendBlankedRange"))
    assertTrue("Mapped source range must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.model.BendTextRange"))
    ...
    assertTrue("Automatic checker must be inspected", classes.contain("com.dearlordylord.bend.idea.adapters.intellij.BendBackgroundChecking"))
    assertTrue("Checking status policy must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.model.BendCheckingStatus$"))
    assertTrue("Check transition policy must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendCheckTransitionPolicy$"))
    assertTrue("Immutable check state must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendCheckState"))
    assertTrue("Check transition result must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendCheckTransition"))
    assertTrue("Check events must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendCheckEvent"))
    assertTrue("Background scheduling intent must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendBackgroundIntent"))
    assertTrue("Background scheduling phases must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendBackgroundPhase$"))
    assertTrue("Check adapter actions must be inspected", classes.contain("com.dearlordylord.bend.idea.analysis.checking.BendCheckAction"))
    assertTrue("Check status UI must be inspected", classes.contain("com.dearlordylord.bend.idea.features.checking.BendCheckStatusAction"))
  ...
  @Test def rejectsForbiddenCompiledScalaDependencies(): Unit =
    ...
    val _ = assertThrows(classOf[AssertionError], () => ArchitectureRules.check(classes, "architecturefixture"))
