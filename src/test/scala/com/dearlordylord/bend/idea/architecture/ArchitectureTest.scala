...
final class ArchitectureTest:
  @Test def productionRespectsBoundaries(): Unit =
    ...
    assertTrue("Shared import graph loader must be inspected", classes.contain("com.dearlordylord.bend.idea.workspace.loading.BendGraphLoader$"))
    assertTrue("Loaded graph model must be inspected", classes.contain("com.dearlordylord.bend.idea.workspace.model.BendLoadedGraph"))
    ...
    assertTrue("Workspace graph API must be inspected", classes.contain("com.dearlordylord.bend.idea.workspace.api.BendWorkspaceGraph"))
    assertTrue("Workspace graph adapter must be inspected", classes.contain("com.dearlordylord.bend.idea.adapters.intellij.BendWorkspaceGraphService"))
    assertTrue("Import path policy must be inspected", classes.contain("com.dearlordylord.bend.idea.workspace.api.BendImportPaths$"))
    assertTrue("Import path completion must be inspected", classes.contain("com.dearlordylord.bend.idea.features.completion.BendImportPathCompletion$"))
    assertTrue("Workspace path catalog API must be inspected", classes.contain("com.dearlordylord.bend.idea.workspace.api.BendWorkspacePaths"))
