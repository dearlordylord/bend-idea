...
import com.intellij.psi.codeStyle.{CommonCodeStyleSettings, FileTypeIndentOptionsProvider}

final class BendIndentOptionsProvider extends FileTypeIndentOptionsProvider:
  override def getFileType: FileType = FileTypeManager.getInstance.getFileTypeByExtension("bend")
  override def createIndentOptions(): CommonCodeStyleSettings.IndentOptions =
    ...
    options
  override def getPreviewText: String = "def main():\n  do IO<Unit>:\n    IO.print(\"Bend\")\n"
