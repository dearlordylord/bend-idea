...
/** Registers the current bounded Bend library inventory as project library
  * roots.
  */
final class BendSymbolLibraryRootsProvider
    extends AdditionalLibraryRootsProvider:
  override def getAdditionalProjectLibraries(
      project: Project
