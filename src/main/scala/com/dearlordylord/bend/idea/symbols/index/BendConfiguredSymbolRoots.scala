...
object BendConfiguredSymbolRoots:
  ...
  private final class ConfiguredRootsScope(
    ...
    override def contains(file: VirtualFile): Boolean =
      delegate.contains(file) || roots.exists(root =>
