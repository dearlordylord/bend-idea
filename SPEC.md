...
Local links refer to the supplied reference checkouts. Those directories are ignored by this project's Git configuration, so pinned upstream links are included for reproducibility. Retain the pinned revisions when comparing behavior; current default branches may have changed.
...
| Quint IDEA architecture/build | [README](.references/quint-idea/README.md), [PRD](.references/quint-idea/PRD.md), [build](.references/quint-idea/build.gradle.kts), [properties](.references/quint-idea/gradle.properties), [plugin registration](.references/quint-idea/src/main/resources/META-INF/plugin.xml) | [Recorded upstream revision](https://github.com/dearlordylord/quint-idea/tree/8cc27d68fd500d041a41aa34658d30c330898826) |
| Quint platform lessons | [Instructions](.references/quint-idea/AGENTS.md), [learnings](.references/quint-idea/LEARNINGS.md) | [Recorded upstream learnings](https://github.com/dearlordylord/quint-idea/blob/8cc27d68fd500d041a41aa34658d30c330898826/LEARNINGS.md) |
| Quint implementations/tests | [Production Kotlin](.references/quint-idea/src/main/kotlin/com/dearlordylord/quint/idea), [fixture tests](.references/quint-idea/src/test/kotlin/com/dearlordylord/quint/idea) | [Recorded upstream source](https://github.com/dearlordylord/quint-idea/tree/8cc27d68fd500d041a41aa34658d30c330898826/src) |
...
Quint's checkout is cloned from a local sibling repository. Its public upstream above is recorded in its own instructions; public availability of that revision has not been verified. The supplied local checkout is the authoritative reference for this study. The standalone Quint grammar snapshot has no recorded commit in the supplied reference notes; its upstream link is deliberately marked unpinned. Preserve notices/licenses when adapting source: [Bend license](.references/bend/LICENSE), [VS Code license](.references/bend-vscode/LICENSE), [Quint license](.references/quint-idea/LICENSE) and [Quint third-party notices](.references/quint-idea/NOTICE).
...
### Skill and issue-tracker handoff

This document follows the problem/solution/stories/implementation/testing/scope/notes template of the user-invoked [to-spec skill](/Users/firfi/.agents/skills/to-spec/SKILL.md). The requested artifact is local Markdown. The project currently has no Git remote or configured issue tracker, so no issue was published. The skill says to run `/setup-matt-pocock-skills` when tracker configuration is absent. If tracker publication is requested after setup, publish this concrete specification with the `ready-for-agent` label. Local document creation does not depend on that setup.
