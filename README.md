...
1. In IntelliJ IDEA 2025.1 or a verified newer version, open **Settings → Plugins → gear icon → Manage Plugin Repositories**, add `https://dearlordylord.github.io/bend-idea/updatePlugins.xml`, then search for **Bend2** in the Marketplace tab and install it. Restart if prompted. Editing features work immediately.
